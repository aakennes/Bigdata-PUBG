...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 z-50 h-[100px] w-full transition-all duration-300 ${
      ...
      >
        ...
        <Wrapper className="flex h-full !max-w-full items-center justify-between gap-8 whitespace-nowrap text-inherit">
          ...
          <Navigation
            ...
            listClassName="flex gap-8 items-center p-20"
            itemClassName="h-[55px] flex items-center p-10"
          />
